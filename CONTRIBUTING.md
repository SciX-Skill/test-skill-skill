...
Welcome! This guide explains how to contribute to Test Skill.
...
```bash
git clone https://github.com/<YOUR_USERNAME>/test-skill-skill.git
cd test-skill-skill
```
...
git clone https://github.com/SciX-Skill/test-skill-skill.git
cd test-skill-skill
...
https://github.com/SciX-Skill/test-skill-skill/issues
